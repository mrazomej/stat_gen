(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("a88bd3a7-2fa8-4278-972b-842e7c037675");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'a88bd3a7-2fa8-4278-972b-842e7c037675' but no matching script tag was found. ")
        return false;
      }
