...
changes in both types of organisms, i.e.,
$$
\frac{d N_\text{tot}(t)}{dt} = \frac{dN_A(t)}{dt} + \frac{dN_a(t)}{dt} 
= f_A N_A(t) + f_a N_a(t),
$${#eq-dNtot_dt}
where for the second equality, we substituted the right hand side of
@eq-expo_growth for each of the alleles.
