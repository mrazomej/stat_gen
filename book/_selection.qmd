...
of organisms in the population, we won't worry about what it mean to have
...
$\lambda_A$. As discussed before, we will use this growth rate as a proxy for
fitness; this is sometimes called Malthusian fitness after Thomas Robert
Malthus---famous scholar whose essay on population growth inspired both Darwin
and Wallace. This growth rate has units of $\lambda_A [=]
...
$$
\bar{f}(t) = \lambda_A x(t) + \lambda_a (1 - x(t)).
$${#eq-pop_fitness_def}
...
$$
\frac{dx}{dt} = \lambda_A x(t) - x(t) \left[\lambda_A x(t) + \lambda_a (1 - x(t))\right].
$${#eq-dx_Dt_chainrule_4}
Grouping terms by the fitness values results in
$$
\frac{dx}{dt} = \lambda_A x(t)(1 - x(t)) - \lambda_a x(t)(1 - x(t)) = s x(t)(1 - x(t)),
